var config = {
  ...
  showMarkers: false,
  theme: 'dark', // 네가 설정한 스타일이 다크톤이라 변경함
  use3dTerrain: false,
  ...
  chapters: [
      ...
      },
      {
          ...
          onChapterEnter: [
              { layer: 'geo-export-7g8024', opacity: 0.7 }
          ],
          onChapterExit: [
      ...
      },
      {
          ...
          onChapterEnter: [
              { layer: 'geo-export-7g8024', opacity: 0.4 },
              { layer: 'greenroofdata2016-20180917-4qmirf', opacity: 0.6 }
          ],
          onChapterExit: []
      }
  ]
